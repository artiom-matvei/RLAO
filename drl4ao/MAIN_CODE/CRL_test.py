...
class SoftQNetwork(nn.Module):
    def __init__(self, env):
        ...
        self.net = nn.Sequential(
            nn.Conv2d(20 + 1, 256, kernel_size=3, stride=1, padding=1),
            nn.LeakyReLU(),
...
class Actor(nn.Module):
    def __init__(self, env):
        ...
        self.fc_mean = nn.Linear(9, np.prod(env.single_action_space.shape))
        self.fc_logstd = nn.Linear(9, np.prod(env.single_action_space.shape))
        # action rescaling
...
if __name__ == "__main__":
    ...
    if args.autotune:
        # Claude said to add a factor of .5
