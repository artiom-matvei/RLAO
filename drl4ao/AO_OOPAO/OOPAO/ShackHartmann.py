...
class ShackHartmann:
    ...
    def initialize_wfs(self):
        ...
        ## TESTING TO SEE IF REFERNCE SLOPES NEED TO BE READJUSTED TO THE SLOPE UNITS
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% WFS INTERACTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __mul__(self,obj): 
        if obj.tag=='detector':
            ...
            ####### ADDED BLURRING BEFORE SENDING TO THE INTEGRATE
            # self.blur_frame = self.camera_frame.copy()
            # self.blur_frame = gaussian_filter(self.blur_frame, sigma=1)
            # obj.integrate(self.blur_frame)
            ###############
